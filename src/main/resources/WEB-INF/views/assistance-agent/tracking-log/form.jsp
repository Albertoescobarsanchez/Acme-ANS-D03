...
<acme:form>
	...
	<acme:input-textbox code="assistance-agent.tracking-log.form.label.claim" path="claim" readonly="true"/>
	...
	<jstl:choose>
			...
			<jstl:when test="${_command == 'create'}">
				<acme:submit code="assistance-agent.tracking-log.form.button.create" action="/assistance-agent/tracking-log/create?id=${claim.id}"/>
			</jstl:when>		
	</jstl:choose>	
